        ...
        <TR>
          <TD height=25 background=files/bgtop.gif>
            <TABLE width="100%">
              <TBODY>
              <TR>
                <TD width="90%" align=left><STRONG>　<FONT color=#ffffff>退货记录</FONT></STRONG></TD>
...
align=center>
              ...
              <TR>
                <TD>
                  ...
                  <%
                  	ArrayList<Orders> orderlist = (ArrayList<Orders>)dao.findByHql(" from Order where memberid='"+member.getId()+"' and type='1' order by id desc ");
                                    int total = 0;
                                    if(orderlist.size()!=0){
                  ...
                  %>
                  	<tr align="center" >
                  		...
                  		<a href="orderThQx.action?id=<%=order.getId() %>">取消退货</a>
                  		<%} %>
                  	</tr>
					<%}} %>
                  </table>

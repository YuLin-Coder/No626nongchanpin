        ...
        <TR>
          <TD height=25 background=files/bgtop.gif>
            <TABLE width="100%">
              <TBODY>
              <TR>
                <TD width="90%" align=left><STRONG>　<FONT color=#ffffff>公益售卖</FONT></STRONG></TD>
...
align=center>
              ...
              <TR>
                <TD>
                  ...
                  int a = 0;
                  PageManager pageManager = PageManager.getPage("/nongchanpin/producttj.jsp?1=1",12, request);
                        ...
                        height=137>
                          ...
                          <TR>
                            ...
                            <%if(product.getField7().equals("yes")){ %>
                                ...
                                <%}else{ %>
                                定价：<%=product.getPrice() %>元        公益售卖有1%的资金投入公益事业，由商家支付
                                <%} %>
                                </DIV></TD></TR>
                                <TR>
                                <TD height=9>

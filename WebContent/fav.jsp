        ...
        <TR>
          <TD height=25 background=files/bgtop.gif>
            <TABLE width="100%">
              <TBODY>
              <TR>
                <TD width="90%" align=left><STRONG>　<FONT color=#ffffff>收藏夹</FONT></STRONG></TD>
...
align=center>
              ...
              <TR>
                <TD>
                  ...
                  <%
                  String hql = " from Product where id in( select productid from Fav where memberid='"+member.getId()+"' ) order by id desc";
                  String url = "/nongchanpin/fav.jsp?1=1";
                  int a = 0;
                  PageManager pageManager = PageManager.getPage("/nongchanpin/fav.jsp?1=1",12, request);
